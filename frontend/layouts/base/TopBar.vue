        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start">
                    ...
                    <form class="md:hidden sm:hidden" @submit.prevent="search">
                ...
                <div class="flex items-center">
                    <button type="button" class="md:hidden sm:hidden text-gray-500 hover:text-gray-900 hover:bg-gray-100 p-2 rounded-lg">
                    ...
                    >
                        ...
                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200">
                            <li>
                                <p class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" @click="() => {}">Settings</p>
                            </li>
                            <li>
                                <a href="#" class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"> Notifications </a>
                            </li>
                        </ul>
                        <div class="py-1">
