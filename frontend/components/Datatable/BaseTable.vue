            ...
            <table v-if="data.length" class="min-w-full">
                ...
                <tr>
                    ...
                    'justify-center': column.align === 'center',
                        ...
                        >
                            ...
                            >
                                <i
                                    class="ri-arrow-up-s-line -mb-2 text-xl"
                                    :class="{'text-blue-600 font-bold': column.sortDirection === 'asc'}"
                                ></i>
                                <i
                                    class="ri-arrow-down-s-line -mt-2 text-xl"
                                    :class="{'text-blue-600 font-bold': column.sortDirection === 'desc'}"
                                ></i>
                            </div>
                            <!-- TODO-->
                ...
                <tr v-if="data.length === 0 && !loading || data.length === 0 && loading" key="empty">
                    <td
                        ...
                        class="text-center py-5 text-gray-500 text-lg td-cell"
                    >
                        <slot name="empty">
    ...
    components: {
        ColumnRenderer: {
            ...
            render() {
                ...
                return h(
                    "span",
                    [getColumnData(this.row, this.column.prop)]
                );
            }
        },
        ColumnHeaderRenderer: {
