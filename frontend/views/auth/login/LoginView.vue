<template>
    <div class="flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
        <div class="self-center mb-6 text-xl font-light text-gray-600 sm:text-2xl dark:text-white">Login To Your Account</div>
        <div class="mt-8">
            <form @submit.prevent="login">
                <div class="flex flex-col mb-2">
                    ...
                    <p v-if="errors.email" class="mb-2 text-sm text-red-600 dark:text-red-500">
                ...
                <div class="flex flex-col mb-6">
                    ...
                    <p v-if="errors.password" class="mb-2 text-sm text-red-600 dark:text-red-500">
                        <span class="font-medium"> Oh, snapp! </span>
                        Some error message.
                    </p>
                </div>
